                ...
                <form class="form-horizontal" action="/borrow/edit" method="post">
                    ...
                    <input hidden type="text" name="id" value="<?= $borrow['id'] ?>">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="date" class="form-control <?= (validation_show_error('release_date')) ? 'is-invalid' : ''; ?>" id="release_date" name="release_date" value="<?= !$borrow['release_date']?old('release_date'):$borrow['release_date'] ?>">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="date" class="form-control <?= (validation_show_error('due_date')) ? 'is-invalid' : ''; ?>" id="due_date" name="due_date" value="<?= !$borrow['due_date']?old('due_date'):$borrow['release_date'] ?>">
                                <div class="invalid-feedback">
